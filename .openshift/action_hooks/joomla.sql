...
--
-- Host: 127.3.77.129:3306
-- Generation Time: May 20, 2013 at 10:59 AM
...
--
-- Table structure for table `dkdso_assets`
--

CREATE TABLE IF NOT EXISTS `dkdso_assets` (
...
--
-- Dumping data for table `dkdso_assets`
--

INSERT INTO `dkdso_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `dkdso_associations`
--

CREATE TABLE IF NOT EXISTS `dkdso_associations` (
...
--
-- Table structure for table `dkdso_banners`
--

CREATE TABLE IF NOT EXISTS `dkdso_banners` (
...
--
-- Table structure for table `dkdso_banner_clients`
--

CREATE TABLE IF NOT EXISTS `dkdso_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `dkdso_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `dkdso_banner_tracks` (
...
--
-- Table structure for table `dkdso_categories`
--

CREATE TABLE IF NOT EXISTS `dkdso_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dkdso_categories`
--

INSERT INTO `dkdso_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 636, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 636, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 636, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 636, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 636, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 636, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 636, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `dkdso_contact_details`
--

CREATE TABLE IF NOT EXISTS `dkdso_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `dkdso_content`
--

CREATE TABLE IF NOT EXISTS `dkdso_content` (
...
--
-- Table structure for table `dkdso_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `dkdso_content_frontpage` (
...
--
-- Table structure for table `dkdso_content_rating`
--

CREATE TABLE IF NOT EXISTS `dkdso_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dkdso_content_types`
--

CREATE TABLE IF NOT EXISTS `dkdso_content_types` (
...
--
-- Dumping data for table `dkdso_content_types`
--

INSERT INTO `dkdso_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`) VALUES
...
--
-- Table structure for table `dkdso_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `dkdso_core_log_searches` (
...
--
-- Table structure for table `dkdso_extensions`
--

CREATE TABLE IF NOT EXISTS `dkdso_extensions` (
...
--
-- Dumping data for table `dkdso_extensions`
--

INSERT INTO `dkdso_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `dkdso_finder_filters`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_filters` (
...
--
-- Table structure for table `dkdso_finder_links`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links` (
...
--
-- Table structure for table `dkdso_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms0` (
...
--
-- Table structure for table `dkdso_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dkdso_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `dkdso_finder_taxonomy`
--

INSERT INTO `dkdso_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `dkdso_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `dkdso_finder_terms`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_terms` (
...
--
-- Table structure for table `dkdso_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `dkdso_finder_terms_common`
--

INSERT INTO `dkdso_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `dkdso_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dkdso_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `dkdso_finder_types`
--

CREATE TABLE IF NOT EXISTS `dkdso_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dkdso_languages`
--

CREATE TABLE IF NOT EXISTS `dkdso_languages` (
...
--
-- Dumping data for table `dkdso_languages`
--

INSERT INTO `dkdso_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `dkdso_menu`
--

CREATE TABLE IF NOT EXISTS `dkdso_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dkdso_menu`
--

INSERT INTO `dkdso_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `dkdso_menu_types`
--

CREATE TABLE IF NOT EXISTS `dkdso_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dkdso_menu_types`
--

INSERT INTO `dkdso_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `dkdso_messages`
--

CREATE TABLE IF NOT EXISTS `dkdso_messages` (
...
--
-- Table structure for table `dkdso_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `dkdso_messages_cfg` (
...
--
-- Table structure for table `dkdso_modules`
--

CREATE TABLE IF NOT EXISTS `dkdso_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dkdso_modules`
--

INSERT INTO `dkdso_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `dkdso_modules_menu`
--

CREATE TABLE IF NOT EXISTS `dkdso_modules_menu` (
...
--
-- Dumping data for table `dkdso_modules_menu`
--

INSERT INTO `dkdso_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `dkdso_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `dkdso_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dkdso_overrider`
--

CREATE TABLE IF NOT EXISTS `dkdso_overrider` (
...
--
-- Table structure for table `dkdso_redirect_links`
--

CREATE TABLE IF NOT EXISTS `dkdso_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dkdso_schemas`
--

CREATE TABLE IF NOT EXISTS `dkdso_schemas` (
...
--
-- Dumping data for table `dkdso_schemas`
--

INSERT INTO `dkdso_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.1.1');

-- --------------------------------------------------------

--
-- Table structure for table `dkdso_session`
--

CREATE TABLE IF NOT EXISTS `dkdso_session` (
...
--
-- Dumping data for table `dkdso_session`
--

INSERT INTO `dkdso_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('2qdu57845skjko09f7fkpeetd2', 1, 0, '1369047156', '__default|a:9:{s:15:"session.counter";i:6;s:19:"session.timer.start";i:1369046531;s:18:"session.timer.last";i:1369047153;s:17:"session.timer.now";i:1369047155;s:24:"session.client.forwarded";s:12:"74.125.61.58";s:22:"session.client.browser";s:111:"Mozilla/5.0 (X11; CrOS x86_64 4100.1.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.4 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"636";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:16:"admin@server.com";s:8:"password";s:65:"c72dbde8a9faa4d2a4c4aacefca1a833:6AN9X4IsOu44dYxi1VulNyHFSxATJTpd";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-05-20 10:41:51";s:13:"lastvisitDate";s:19:"2013-05-20 10:42:11";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"4660dc23fe3331b8fef24e18665a2125";}', 636, 'admin'),
('67oekg528o3fst2dqebecrg8l1', 0, 1, '1369047142', '__default|a:9:{s:15:"session.counter";i:2;s:19:"session.timer.start";i:1369046791;s:18:"session.timer.last";i:1369046791;s:17:"session.timer.now";i:1369047141;s:24:"session.client.forwarded";s:12:"74.125.61.58";s:22:"session.client.browser";s:111:"Mozilla/5.0 (X11; CrOS x86_64 4100.1.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.4 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"d1307d719da84e2f7e7a24eecef46b6f";}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `dkdso_tags`
--

CREATE TABLE IF NOT EXISTS `dkdso_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `dkdso_tags`
--

INSERT INTO `dkdso_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `dkdso_template_styles`
--

CREATE TABLE IF NOT EXISTS `dkdso_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dkdso_template_styles`
--

INSERT INTO `dkdso_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `dkdso_ucm_base`
--

CREATE TABLE IF NOT EXISTS `dkdso_ucm_base` (
...
--
-- Table structure for table `dkdso_ucm_content`
--

CREATE TABLE IF NOT EXISTS `dkdso_ucm_content` (
...
--
-- Table structure for table `dkdso_updates`
--

CREATE TABLE IF NOT EXISTS `dkdso_updates` (
...
--
-- Dumping data for table `dkdso_updates`
--

INSERT INTO `dkdso_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
--
-- Table structure for table `dkdso_update_sites`
--

CREATE TABLE IF NOT EXISTS `dkdso_update_sites` (
...
--
-- Dumping data for table `dkdso_update_sites`
--

INSERT INTO `dkdso_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1369047155),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1369047155),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1369047155);

-- --------------------------------------------------------

--
-- Table structure for table `dkdso_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `dkdso_update_sites_extensions` (
...
--
-- Dumping data for table `dkdso_update_sites_extensions`
--

INSERT INTO `dkdso_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `dkdso_usergroups`
--

CREATE TABLE IF NOT EXISTS `dkdso_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `dkdso_usergroups`
--

INSERT INTO `dkdso_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `dkdso_users`
--

CREATE TABLE IF NOT EXISTS `dkdso_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `dkdso_users`
--

INSERT INTO `dkdso_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(636, 'Super User', 'admin', 'admin@server.com', 'c72dbde8a9faa4d2a4c4aacefca1a833:6AN9X4IsOu44dYxi1VulNyHFSxATJTpd', 0, 1, '2013-05-20 10:41:51', '2013-05-20 10:52:32', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dkdso_user_notes`
--

CREATE TABLE IF NOT EXISTS `dkdso_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dkdso_user_profiles`
--

CREATE TABLE IF NOT EXISTS `dkdso_user_profiles` (
...
--
-- Table structure for table `dkdso_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `dkdso_user_usergroup_map` (
...
--
-- Dumping data for table `dkdso_user_usergroup_map`
--

INSERT INTO `dkdso_user_usergroup_map` (`user_id`, `group_id`) VALUES
(636, 8);

-- --------------------------------------------------------

--
-- Table structure for table `dkdso_viewlevels`
--

CREATE TABLE IF NOT EXISTS `dkdso_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `dkdso_viewlevels`
--

INSERT INTO `dkdso_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `dkdso_weblinks`
--

CREATE TABLE IF NOT EXISTS `dkdso_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
